#!/usr/bin/env bash
# Vendor shared modules into generated/ for the Oh My Pi extension.
...
#
# The Oh My Pi extension is distributed and executed as raw TypeScript through
# jiti (and Bun in tests). A relative "./x.js" specifier names a file that never
