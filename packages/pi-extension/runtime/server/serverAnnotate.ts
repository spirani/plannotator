...
import { getPlanVersion, getVersionCount, listVersions } from "../../storage.ts";
import { computeAnnotateHistory, deriveAnnotateHistorySlug, type AnnotateHistoryResult } from "../../annotate-history.ts";
import { htmlDiff } from "../../html-diff.ts";
import { saveConfig, detectGitUser, getServerConfig, loadConfig, resolveAIEnabled, resolveSharingEnabled, resolveAnnotateHistory, type PromptRuntime } from "../../config.ts";
import { getAnnotateFileFeedbackTemplate, getAnnotateMessageFeedbackTemplate } from "../../prompts.ts";
import { disabledSourceSave, type SourceSaveRequest } from "../../source-save.ts";
import { getAnnotateReferenceRootPaths } from "../../annotate-reference-roots-node.ts";
import {
...
import { resolveUserPath, warmFileListCache } from "../../resolve-file.ts";
...
import { inlineHtmlLocalAssets, isWithinDirectory, MAX_HTML_ASSET_BYTES, resolveOpenInTarget } from "../../html-assets-node.ts";
import {
...
} from "../../annotate-client-lease.ts";
import { createAnnotateDecisionSettler } from "../../annotate-decision.ts";
...
export async function startAnnotateServer(options: {
	...
	const aiRuntime = resolveAIEnabled()
