 ...
 *
 * Kept in a zero-import module so the entrypoint and annotation commands can
 * classify the error synchronously without pulling in plannotator-browser.ts's
 * heavy server/browser import graph.
 */
